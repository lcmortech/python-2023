...
# The diff between an array/list they don't use 0 as heasd or length as tail, like an array list. You can have an index-based head and an index-based tail
